  ...
  ?>
    ...
    <div class="custom-breadcrumns border-bottom">
      ...
      <a href="index.php">Home</a>
        ...
        <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current"><a href="sem5_BCA_DDBMS_questions.php">DDBMS Assignments </a></span>
      </div>
    </div>
    <?php
  include("connect_examspace.php");
  $query = mysqli_query($con, "SELECT * FROM `assignments` WHERE class='BCA'AND  semester='5th' AND  subject='DDBMS'");
  if (!$query) {
    echo "not working";
  }
  ?>
