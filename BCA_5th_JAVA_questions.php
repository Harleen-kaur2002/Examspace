...
?>
 <div class="custom-breadcrumns border-bottom">
      ...
      <a href="index.php">Home</a>
        ...
        <span class="mx-3 icon-keyboard_arrow_right"></span>
        <span class="current"><a href="sem5_BCA_JAVA_questions.php">JAVA Question </a></span>
      </div>
 </div>
    <?php
  include("connect_examspace.php");
  $query = mysqli_query($con, "SELECT * FROM `questions` WHERE class='BCA'AND  semester='5th'AND subject='JAVA'");
  if (!$query) {
    echo "not working";
  }
  ?>
