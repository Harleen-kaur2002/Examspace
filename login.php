...
if(!$select)
{
   ...
   $row=mysqli_fetch_array($sql);
	 ...
	 header("Location:index.php?variable=" .$row['email']);
}
   
    
     else{
      echo ("<script LANGUAGE='JavaScript'>
      window.alert('data  not matched');
      window.location.href='login.php';
      </script>");
    //  echo  '<script>';
    //  echo 'alert("data  not matched")';
    //  echo '</script>';
                ...
                <div class="col-md-5">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group" >
                            ...
                            <span  style="text-align:center;color:red"> <center id = "passtext"></center></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <input type="submit" value="Log In" name="submit" style="display:block; margin:left; " class="btn btn-primary btn-lg px-5">
...
function validateForm() {
  ...
  //  email data validation
    ...
    if(pass1.length > 15) {
      document.getElementById("passtext").innerHTML = "**Sorry, your password was incorrect. Please double-check your password.";
      return false;
    }
