            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                        ...
                        <p><a href="BCA_5th_DDBMS_questions.php" class="btn btn-primary rounded-0 px-4"style="color:white;">click here </a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="course-1-item">
                       ...
                       <div class="category"><h3>Assignments</h3></div>  
                        ...
                        <p class="desc mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique accusantium ipsam.</p> -->
                        <p><a href="BCA_5th_DDBMS_assignment.php" class="btn btn-primary rounded-0 px-4"style="color:white;">click here </a></p>
                        </div>
                    </div>
                </div>
